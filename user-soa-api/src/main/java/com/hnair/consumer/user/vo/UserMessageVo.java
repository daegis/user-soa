...
public class UserMessageVo<T> implements Serializable {

	private static final long serialVersionUID = 4259121449612234023L;
	/**
	...
	public UserMessageVo(boolean result, String message, T t) {
		this.result = result;
		this.message = message;
		this.t = t;
	}

	public UserMessageVo(boolean result, String message, String errorCode, String errorMessage, T t) {
		this.result = result;
		this.message = message;
